...
/**
 * Esta clase define el controlador para acceder ejercicio
 * 
 * @author Ana Rodriguez Duran
 * @author Candelaria Orellana Pero
 */
public class ControladorAccederEjercicio implements ActionListener{
	TreeAcademy ta;
	GUIAplicacion gui;
	
	public ControladorAccederEjercicio(TreeAcademy ta, GUIAplicacion gui){
		this.ta = ta;
		this.gui = gui;
		gui.getVistaAccederEjercicio().setControlador(this);
	}
