...
/**
 * Clase que define la vista para crear un ejercicio
 * 
...
public class VistaCrearEjercicio extends JPanel{
	...
	public VistaCrearEjercicio(){
		...
		/*agregar*/
		layout.putConstraint(SpringLayout.WEST, agregar, 750, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, agregar, 350, SpringLayout.NORTH, this);
	}
