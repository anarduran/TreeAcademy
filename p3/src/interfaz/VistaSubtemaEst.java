...
/**
 * Clase que define la vista de un subtema de estudiante
 * 
 * @author Ana Rodriguez Duran
 * @author Candelaria Orellana Pero 
 */
public class VistaSubtemaEst extends JPanel{
	...
	public VistaSubtemaEst(){
		...
		/*scroll_apun*/
		layout.putConstraint(SpringLayout.WEST, scroll_apun, 300, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, scroll_apun, 270, SpringLayout.NORTH, this);
		
		/*acceder_apun*/
		layout.putConstraint(SpringLayout.WEST, acceder_apun, 320, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, acceder_apun, 450, SpringLayout.NORTH, this);
		
		/*apunte*/
		layout.putConstraint(SpringLayout.WEST, apunte, 320, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, apunte, 230, SpringLayout.NORTH, this);
		
		/*scroll_ejer*/
		layout.putConstraint(SpringLayout.WEST, scroll_ejer, 600, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, scroll_ejer, 270, SpringLayout.NORTH, this);
		
		/*acceder_ejer*/
		layout.putConstraint(SpringLayout.WEST, acceder_ejer, 620, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, acceder_ejer, 450, SpringLayout.NORTH, this);
		
		/*ejercicio*/
		layout.putConstraint(SpringLayout.WEST, ejercicio, 620, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, ejercicio, 230, SpringLayout.NORTH, this);
