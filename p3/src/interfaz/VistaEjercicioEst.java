...
public class VistaEjercicioEst extends JPanel{
	...
	public VistaEjercicioEst(){
		...
		titulo = new JLabel("<<EJERCICIO ESTUDIANTE>>");
		...
		/*boton guardar*/
		layout.putConstraint(SpringLayout.WEST, guardar, 200, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, guardar, 550, SpringLayout.NORTH, this);
		
		/*boton cancelar*/
		layout.putConstraint(SpringLayout.WEST, cancelar, 310, SpringLayout.WEST, this);
		layout.putConstraint(SpringLayout.NORTH, cancelar, 550, SpringLayout.NORTH, this);
	}
