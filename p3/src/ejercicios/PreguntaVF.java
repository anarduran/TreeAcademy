...
/**
 * Clase heredada de Pregunta. Clase del tipo de pregunta de verdadero o falso 
...
public class PreguntaVF extends Pregunta {
     ...
     */
	public PreguntaVF(double nota, String enunciado, double penalizacion){
		super(nota, enunciado, penalizacion);
		this.setIdPregunta(1);
	}
}