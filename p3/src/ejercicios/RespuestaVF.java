...
/**
 * Clase heredada de Respuesta. Clase del tipo de respuesta verdadero o falso
...
public class RespuestaVF extends Respuesta {
	...
	public String toString() {
		return "RespuestaVF [respuesta=" + respuesta + "]";
	}

	private static final long serialVersionUID = 1L; /*id para la implementazion Serializable*/
	private String respuesta; /*respuesta introducida, true correcto, false, incorrecto*/
     ...
     */
	public RespuestaVF(Pregunta pregunta, String respuesta){
		super(pregunta);
